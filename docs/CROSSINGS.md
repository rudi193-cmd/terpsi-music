...
2. **Neither surface had a test.** `craft/__main__.py` had no test of any kind —
   ...
   under `craft/` carried an ablation row. 120 mutations, none of them aimed at
...
Counts in this addendum were derived from the tree on 2026-08-01: 125 mutations
in `tests/ablate.py` after this change, five of them the first to point at
`craft/`.
