...
MUTATIONS = [
    ...
    ("tools/manifest.py", "    return tuple(p for p in _all_python() if _excused(p.relative_to(ROOT)) is None)",
     "    return tuple(p for p in _all_python() if 'presentation' not in p.parts)",
