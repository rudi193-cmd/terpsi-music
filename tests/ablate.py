...
MUTATIONS = [
    ...
    ("tools/discipline.py", "return name.lstrip(\"_\").lower() in STANDING_NAMES",
     "return name.lower() in STANDING_NAMES",
     "a leading underscore does not hide it", "tests/test_discipline.py"),
